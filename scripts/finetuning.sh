...
#SBATCH --job-name Finetuning_T10_Adam_iblurry_cifar100
#SBATCH -p batch
#SBATCH --nodes=1
#SBATCH -w vll1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
MODE="Finetuning"
NOTE="[$MODE]_T10_Adam_iblurry_cifar100_3epoch" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
