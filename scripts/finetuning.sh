...
#SBATCH --job-name Finetuning_iblurry_cifar10_N50_M10
#SBATCH -p batch
#SBATCH -w vll1
#SBATCH --nodes=1
#SBATCH --gres=gpu:2
...
# CIL CONFIG
MODE="Finetuning"
NOTE="Finetuning_iblurry_cifar10_N50_M10" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
