...
#SBATCH -J CLIB_ViT_LP_iblurry_CIFAR100_N50_M10
#SBATCH -p batch
#SBATCH -w augi1
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="CLIB_ViT_LinearProve_iblurry_CIFAR_100_N100_M10" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="clib_vit_LP"
