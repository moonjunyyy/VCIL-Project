...
#SBATCH --job-name Ours_iblurry_cifar100_N50_M10_rnd
#SBATCH -p batch
#SBATCH -w vll4
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
MODE="Ours"
NOTE="Ours_iblurry_cifar100_N50_M10" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
