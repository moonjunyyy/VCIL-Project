...
#SBATCH -J Ours_total_Siblurry_C_M_I_a_0.5_G_2
#SBATCH -p batch_agi
#SBATCH -w agi2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="Ours_total_Siblurry_C_M_I_a_0.5_G_2" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="Ours_total"
...
do
    ...
    --alpha 0.5 --gamma 2. --use_base_ce --no-use_compensation_ce \
    --no-use_last_layer \
    --use_contrastiv \
    --use_mask
