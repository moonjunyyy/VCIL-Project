...
#SBATCH -J Ours_Siblurry_k_1_N50_M10
#SBATCH -p batch_agi
#SBATCH -w agi1
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="Ours_Si_Blurry_Topk_1_N50_M10" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours"
