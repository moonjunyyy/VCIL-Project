...
#SBATCH -J ViT_FT_iblurry_cifar10_N50_M10
#SBATCH -p batch
#SBATCH -w vll1
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="ViT_FT_iblurry_cifar10_N50_M10" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ViT_FT"
...
do
    ...
    --note $NOTE --eval_period $EVAL_PERIOD --memory_epoch $MEMORY_EPOCH $USE_AMP --debug --rnd_NM
done
