...
#SBATCH -J Ours_cifar100_N50_M10
#SBATCH -p batch_agi
#SBATCH -w agi2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="Ours_Siblurry_cifar100_N50_M10_test" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours"
...
do
    ...
    --note $NOTE --eval_period $EVAL_PERIOD --n_worker 4 --rnd_NM --debug
done
