...
#SBATCH -J Ours_Siblurry_loss_update
#SBATCH -p batch_agi
#SBATCH -w agi2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="Ours_Siblurry_cifar100_N50_M10_update" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours"
