...
#SBATCH -J Ours_total_Baseline_new
#SBATCH -p batch_agi
#SBATCH -w agi2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="ours_total_Baseline" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="Ours_total"
...
do
    ...
    --note $NOTE --eval_period $EVAL_PERIOD --n_worker 2 --rnd_NM --selection_size 1 --alpha 0.0 --gamma 0. --beta 0. --charlie 0. \
    --use_last_layer --no-use_contrastiv --no-use_mask --use_baseline
done
