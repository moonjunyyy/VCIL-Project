...
#SBATCH -J OCS_ViT_iblurry_CIFAR10_N50_M10
#SBATCH -p batch
#SBATCH -w vll1
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="OCS_ViT_iblurry_CIFAR10_N100_M10" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ocs_vit"
