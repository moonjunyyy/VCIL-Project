...
#SBATCH -J L2P_K_Adam_iblurry_cifar100
#SBATCH -p batch
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="[L2P_K-Adam]_iblurry_cifar100_3epoch" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="L2P"
...
if [ "$DATASET" == "cifar10" ]; then
    ...
    BATCHSIZE=16; LR=0.03 OPT_NAME=$OPT SCHED_NAME="cos" MEMORY_EPOCH=256
