...
if [ "$DATASET" == "cifar10" ]; then
    ...
    BATCHSIZE=16; LR=3e-2 OPT_NAME="adam" SCHED_NAME="default" IMP_UPDATE_PERIOD=1
    ...
    MODEL_NAME="resnet34" EVAL_PERIOD=100
    BATCHSIZE=32; LR=3e-2 OPT_NAME="adam" SCHED_NAME="default" IMP_UPDATE_PERIOD=1

elif [ "$DATASET" == "imagenet" ]; then
    N_TASKS=10 MEM_SIZE=20000 ONLINE_ITER=0.25
    MODEL_NAME="resnet34" EVAL_PERIOD=1000
    BATCHSIZE=256; LR=3e-2 OPT_NAME="adam" SCHED_NAME="default" IMP_UPDATE_PERIOD=10
