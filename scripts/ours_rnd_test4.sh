...
#SBATCH -J Ours_rnd_test_M_I_Comp_G1_One_Loss_Term
#SBATCH -p batch_agi
#SBATCH -w agi2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="Ours_rnd_test_M_I_Comp_G1_One_Loss_Term" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours_test"
...
do
    ...
    --alpha 0.5 --gamma 1. --no-use_base_ce --no-use_compensation_ce \
    --no-use_last_layer \
    --no-use_contrastiv \
    --use_mask
