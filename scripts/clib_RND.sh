...
#SBATCH -J PD_CLIB_iblurry_RND_CIFAR100_N50_M10_RND
#SBATCH -p batch
#SBATCH -w vll4
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="PD_CLIB_iblurry_RND_CIFAR100_N50_M10_RND" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="clib"
