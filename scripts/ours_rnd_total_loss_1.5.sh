...
#SBATCH -J Ours_total_new_sub_1.5
#SBATCH -p batch_agi
#SBATCH -w agi2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# CIL CONFIG
NOTE="ours_total_loss1.5" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="Ours_total"
...
do
    ...
    --note $NOTE --eval_period $EVAL_PERIOD --n_worker 2 --rnd_NM --selection_size 1 --alpha 1.5 --gamma 1. --beta 0.5 --charlie 1.5 \
